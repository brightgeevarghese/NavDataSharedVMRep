package edu.miu.navdatatranssharedvmr.ui.components
...
fun TopBar(navController: NavHostController) {
    ...
    navController.addOnDestinationChangedListener {
            ...
            canNavigateBack = navController.currentDestination?.route != "homeScreen"
    }
    TopAppBar(
        title = {
            Text(text = "Maharishi International University")
        },
